...
```
+-------------------------------------------------------------------------------+
|  GitHub Copilot Analytics & Billing Dashboard (2026.09)          [Mode: Light/Dark] |
|  Repo: proud-corp/github-copilot-dashboard | Last Synced: 2026-09-10 09:00 JST     |
+-------------------------------------------------------------------------------+
| [1. 分析スコープ選択]                                                         |
|  (●) 日次: [2026-09-09 ▼]   ( ) 月次: [2026-09 ▼]   ( ) 指定期間: [開始〜終了] |
+-------------------------------------------------------------------------------+
| [2. グループ軸選択]                                                           |
|  [● 任意仕訳グループ (部署・PJ)]   [  GitHub Cost Center  ]   [  Organization  ] |
+-------------------------------------------------------------------------------+
| [3. KPI サマリーカード]                                                       |
|  +--------------+  +--------------+  +--------------+  +--------------+       |
...
### 2.2 グループ切り替え (3軸)
タブまたはボタングループで即座に切り替え：
1. **任意仕訳グループ (Department / Project Group)**: ユーザー属性テーブルで設定された組織区分。
