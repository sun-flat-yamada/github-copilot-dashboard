        ...
        <div className="max-w-[1600px] w-full mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-3 sm:gap-6">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 text-xs min-w-0 flex-shrink justify-end">
            ...
            <a
              ...
              className="flex items-center space-x-1.5 text-slate-400 hover:text-slate-100 bg-slate-900 border border-slate-800 hover:border-slate-700 px-2.5 sm:px-3 py-1.5 rounded-xl transition-all shadow-sm group cursor-pointer min-w-0 flex-shrink max-w-[130px] sm:max-w-[190px] lg:max-w-[260px]"
